...
#ui button{font-size:15px;border-width:1px;border-color:var(--line);border-radius:4px;background-color:#ead8b9;background-image:linear-gradient(#fff9edc4,#dbc29bc4),url('assets/ui-paper-target-v2.webp');background-size:auto,220px;color:var(--ink);box-shadow:0 1px 0 #fff8 inset,0 1px 1px #2d1d1022;transition:background-color .12s,border-color .12s,transform .08s,box-shadow .12s}
...
#ui .pane{border:1px solid var(--brass);border-radius:3px;background-color:var(--paper);background-image:linear-gradient(#ffffff28,#79572812),url('assets/ui-paper-target-v2.webp');background-size:auto,360px;box-shadow:0 3px 12px #170d0840,inset 0 0 0 1px #fff8df99,inset 0 0 18px #8f62221a}
