...
#ui.material-hd :is(.top-actions>button,.top-tools button,.primary-action,.staff-recruit-entry,.compare-hire,.compare-tray button){border:6px solid transparent;border-image:url('assets/ui-control-ornament-v3.webp') 40 72 fill / 6px 12px stretch;background-color:#ead1a8;color:#52331e;box-shadow:0 3px 5px #2b160b40,inset 0 2px #fffbe7cc,inset 0 -3px #6a3b162f}
#ui.material-hd :is(.top-actions>button,.top-tools button,.primary-action,.staff-recruit-entry,.compare-hire,.compare-tray button):hover{border-color:transparent;background-color:#f0dfc0;box-shadow:0 4px 7px #2b160b4d,inset 0 2px #fffef0e8,inset 0 -3px #75421838}
