...
#ui button{box-sizing:border-box;font-size:15px;border-width:1px;border-color:var(--line);border-radius:4px;background-color:#ead8b9;background-image:linear-gradient(#fff9edc4,#dbc29bc4),url('assets/ui-paper-target-v2.webp');background-size:auto,220px;color:var(--ink);box-shadow:inset 0 0 0 1px #fff9df88,inset 0 -2px #8f66302b,0 1px 1px #2d1d1022;transition:background-color .12s,border-color .12s,transform .08s,box-shadow .12s}
#ui button:hover{filter:none;border-color:var(--brass);background-color:#efdfc4;background-image:linear-gradient(#fffdf6b8,#dec39bb8),url('assets/ui-paper-target-v2.webp')}
