...
import { portraitURL } from './portrait-v2.js';
...
img.portrait{image-rendering:auto;width:120px;height:160px;flex:0 0 120px;object-fit:cover;border:2px solid #796B83;border-radius:8px;background:#D8D4DF;box-shadow:0 6px 16px #35244655,inset 0 0 0 1px #ffffff80}
img.portrait.compact{width:96px;height:128px;flex-basis:96px} .portrait-head{align-items:flex-start!important}.portrait-head>div{min-width:0}.portrait-note{padding:7px 9px;border-left:3px solid #94749A;background:#5d477018;border-radius:0 7px 7px 0}
