...
export const EYES           = [
  ...
  { id: 'star', name: '星芒瞳', rows: ['.KK.', 'GSGK', 'SEeK', '.S..'] },
  { id: 'moon', name: '月牙眼', rows: ['KKKK', '.GeK', 'SSE.', '.K..'] },
  { id: 'gem', name: '宝石瞳', rows: ['.KK.', 'GEEK', 'SGeK', '.S..'] },
  { id: 'fox', name: '狐媚眼', rows: ['...K', 'KGeK', 'SSK.'] },
  { id: 'puppy', name: '无辜眼', rows: ['KKK.', 'GEEK', 'SGeK', '.S..'] },
...
export const FRINGES              = [
  ...
  { id: 'wispy', name: '空气刘海', spans: [
    [15, 8, 'HHHHHHHHHH'],
    [16, 8, 'DHDHDHDHDH'],
    [17, 9, 'H.H.H.H.D'],
    [18, 11, 'D...D.D'],
  ] },
  { id: 'himecut', name: '公主切刘海', spans: [
    [15, 8, 'HHHHHHHHHH'],
    [16, 8, 'HHHHHHHHHH'],
    [17, 8, 'DDDDDDDDDD'],
    [18, 8, 'HH......HH'],
...
export const LENGTHS              = [
  ...
  { id: 'crown', name: '王冠盘发', dome: TIGHT_DOME, fringeMax: 15, under: [
    [0, 13, 'XM.M.M'],
    [1, 12, 'XMMMMMM'],
    [2, 12, 'XHHHHHM'],
    [3, 11, 'XHHHHHH'],
  ...
  { id: 'feather', name: '羽翎高束', dome: TIGHT_DOME, fringeMax: 15, under: [
    [0, 10, 'XLL'],
    [1, 9, 'XLLLL'],
    [2, 10, 'XLLL'],
    [3, 11, 'XLL'],
